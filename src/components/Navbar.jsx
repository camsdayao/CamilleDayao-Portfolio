      ...
      <div className="flex items-center justify-around">
        <div className="pt-2 cursor-pointer hover:bg-orange-50">
          <Link to="Hero" smooth={true} duration={500}>
            <h3 class="font-bold text-3xl mr-8 md:text-4xl">Camille Dayao</h3>
            <h2 class="mr-2 md:text-2xl">Software Engineer</h2>
          </Link>
        </div>
        <div className="hidden lg:flex space-x-8 font-normal items-justify">
          <div>
            <a
              href="#"
              class="underline hover:underline-offset-2 cursor-pointer hover: font-normal"
            >
        ...
        <div className="flex mx-20 cursor-pointer items-center space-x-3">
          ...
          <div className={!lightSwitch ? "space-x-2" : "bg-slate-800"}></div>
        </div>
      </div>
